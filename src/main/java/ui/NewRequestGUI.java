...
public class NewRequestGUI {
    ...
    public NewRequestGUI(RequestManagerController controller){
        frame = new JFrame("Add new request");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        //###### TITLE #######
        title = new JLabel("Add new request", SwingConstants.CENTER);
        ...
        selectAddressLabel = new JLabel("Select an address for the request", SwingConstants.CENTER);
        ...
        addButton.addActionListener(e->controller.addNewRequest());
